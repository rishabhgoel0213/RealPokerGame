...
def create_match(user_pair):
    try:
        ...
        player1_raise = 0.01 * 0.01 * user1_rating
        player2_raise = 0.01 * 0.01 * user2_rating

        player1_pot = 0.01 * user1_rating - player1_raise
        player2_pot = 0.01 * user2_rating - player2_raise
